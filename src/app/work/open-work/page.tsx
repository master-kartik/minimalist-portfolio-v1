...
const WorkPage = ({searchParams}:Props) => {
  ...
  return (
    ...
    <div className='fixed bottom-4 right-8'><JoinWaitlistButton textVal={''}/></div>
      </header>
      <article className='flex flex-col text-balance items-left justify-center w-[85vw] md:w-[50vw] text-left mt-24 tracking-tight'>
        <h3 className='blog-heading'>what & why i wanted?</h3>
        ...
        <br />
        <h3 className='blog-heading'>tech stack i used.</h3>
        ...
        <br />
        <h3 className='blog-heading'>how i get it?</h3>
