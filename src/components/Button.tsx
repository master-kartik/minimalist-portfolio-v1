...
const JoinWaitlistButton = ({textVal}:TextType) => {
    return (
        <button
            type="button"
            className="relative tracking-tighter inline-flex items-center justify-center bg-white md:bg-transparent hover:text-white hover:bg-neutral-700 duration-700 px-10 md:px-16 py-4 text-neutral-900"
        >
            <div
